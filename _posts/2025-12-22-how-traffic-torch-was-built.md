...
To make Traffic Torch fast, private, and future-proof:

- HTML5 & Tailwind CSS – responsive, mobile-first design
- JavaScript (ES6+) – client-side analysis
- Chart.js – for the 360° radar
- CORS Proxy – secure page fetching
- PWA-ready – installable on mobile
- Dark/light mode – respects system preference

The tool runs entirely in-browser – no data sent to servers.
