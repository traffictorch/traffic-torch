  ...
  const metrics = [
    {
      ...
      grade: schemaPotential >= 65 ? 'good' : schemaPotential >= 40 ? 'warning' : 'bad'
    },
    {
    ...
    },
    {
      ...
      grade: consistencyPercent >= 90 ? 'good' : consistencyPercent >= 80 ? 'warning' : 'bad'
    }
  ];

  // ── Failed / improvement suggestions — unchanged ─────────────────────
  const failed = [];
