// Renders the 9 AEO module explanation cards into #module-cards-container on page load.
// Compact by default; expand to show what / how / why with per-section guide links.
import { moduleExplanations } from './module-explanations-v1.0.js';

const MODULE_META = {
  "Render Fidelity":                  { icon: "🔬", color: "from-orange-500 to-red-500" },
  "DOM Stability":                    { icon: "🧱", color: "from-red-500 to-pink-500" },
  "Content Extractability":           { icon: "📄", color: "from-pink-500 to-purple-500" },
  "Schema Parse Performance":         { icon: "🧬", color: "from-purple-500 to-indigo-500" },
  "Crawler Accessibility":            { icon: "🚪", color: "from-indigo-500 to-blue-500" },
  "Text Density Performance":         { icon: "📊", color: "from-blue-500 to-cyan-500" },
  "Semantic Structure Integrity":     { icon: "🏗️", color: "from-cyan-500 to-teal-500" },
  "Render Blocking Performance":      { icon: "🚧", color: "from-teal-500 to-emerald-500" },
  "Content Stability Performance":    { icon: "🔒", color: "from-emerald-500 to-green-500" }
};
...
export function renderModuleCards(containerId = 'module-cards-container') {
  ...
  const guideBase = '/blog/posts/aeo-performance-help-guide/';
