  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const res = await fetch(ANALYZE_ENDPOINT, {
        ...
        body: JSON.stringify({ url, deep: isSiteWide }),
      ...
      results.innerHTML = `
        <div class="max-w-5xl mx-auto px-4 py-8 text-gray-800 dark:text-gray-200">
          ...
          <p class="text-center text-sm text-gray-600 dark:text-gray-400 mb-6 italic">
            ${isSiteWide 
              ? 'Site-Wide Analysis: Main page + supporting internal pages scanned' 
              : 'Single-Page Analysis: Only the submitted URL was processed'}
          </p>
