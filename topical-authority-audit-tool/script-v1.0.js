      ...
      results.innerHTML = `
        <div class="max-w-5xl mx-auto px-4 py-8 text-gray-800 dark:text-gray-200">
          ...
          <div class="flex justify-center my-12">
            <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-10 w-full max-w-lg border-4 border-transparent ${overallScore >= 85 ? 'border-green-500 dark:border-green-400' : overallScore >= 70 ? 'border-emerald-500 dark:border-emerald-400' : overallScore >= 50 ? 'border-orange-500 dark:border-orange-400' : 'border-red-500 dark:border-red-400'} shadow-lg dark:shadow-gray-800/50">
              ...
              <div class="relative aspect-square w-full max-w-[300px] mx-auto">
                <svg viewBox="0 0 200 200" class="w-full h-full transform -rotate-90">
                  ...
                  <circle cx="100" cy="100" r="90"
                          class="${overallScore >= 85 ? 'stroke-green-500 dark:stroke-green-400' : overallScore >= 70 ? 'stroke-emerald-500 dark:stroke-emerald-400' : overallScore >= 50 ? 'stroke-orange-500 dark:stroke-orange-400' : 'stroke-red-500 dark:stroke-red-400'}"
                          stroke-width="16" fill="none"
                          stroke-dasharray="${(overallScore / 100) * 565} 565" stroke-linecap="round"/>
                </svg>
                <div class="absolute inset-0 flex items-center justify-center text-center">
                  <div>
                    <div class="text-7xl font-black ${overallScore >= 85 ? 'text-green-600 dark:text-green-400' : overallScore >= 70 ? 'text-emerald-600 dark:text-emerald-400' : overallScore >= 50 ? 'text-orange-600 dark:text-orange-400' : 'text-red-600 dark:text-red-400'}">${overallScore}</div>
