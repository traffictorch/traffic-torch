document.addEventListener('DOMContentLoaded', () => {
  ...
  const analyze = (text, doc) => {
    ...
    // AI Fixes (simple client-side suggestions based on scores)
    const aiFixes = [];
    ...
    try {
      ...
      report.innerHTML = `
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-12 border border-orange-500/30 text-center">
          <div class="score-ring-big mx-auto mb-12" style="--score: ${r.score}%; --bg: #f3f4f6 dark:#111827;">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mx-auto mb-16">
            ${[
              ...
              {name:"Readability",value:r.readability,score: Math.min(100, (r.readability / 100 * 100)),what:"Flesch-Kincaid grade level",how:"Simplify language",why:"AI prefers easy-to-summarize content",fix:r.readability>60?[]:["Short sentences (15-20 words)","Active voice","Common words"]},
              ...
              <div class="metric-card">
                ...
                <div class="module-circle mb-6" style="--module-score: ${m.score}%; --bg: #f3f4f6 dark:#111827;">
                  <div class="absolute inset-0 flex items-center justify-center">
          ...
          <div class="forecast-card">
            ...
            <p class="text-xl text-gray-300">${r.forecast}</p>
