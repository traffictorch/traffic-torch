...
const modules = [
  ...
  { name: 'Traditional Keyword Performance', score: analysis.moduleScores[4], id: 'traditional-keywords', info: 'Measures conversational long-tail density & question coverage.', /* ... */ }
      ...
      setTimeout(() => {
        ...
        results.innerHTML = `
<!-- Overall Score Card (AI Voice Search) -->
  ...
  <div id="share-form-container" class="hidden max-w-2xl mx-auto mt-8">
    <form id="share-form" class="space-y-6 bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-orange-500/30">
      ...
      <div>
        ...
        <input id="share-title" type="text" required placeholder="Traffic Torch AI Voice Search Report" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-2xl px-6 py-4 focus:outline-none focus:border-orange-500">
      </div>
      <div>
  ...
  <div id="feedback-form-container" class="hidden max-w-2xl mx-auto mt-8">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-blue-500/30">
      <p class="text-lg font-medium mb-6 text-gray-800 dark:text-gray-200">
        Feedback for AI Voice Search Tool on <strong>${document.body.getAttribute('data-url') || 'the analyzed page'}</strong>
      </p>
