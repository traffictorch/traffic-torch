document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async e => {
    ...
    const loaderHTML = `
      <div class="flex flex-col items-center justify-center py-32 space-y-16">
        <div class="relative">
          <svg class="animate-spin h-32 w-32 text-orange-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
        </div>
        <div class="text-center space-y-6">
          <p class="text-4xl font-black text-gray-800 dark:text-gray-200">Analyzing your page...</p>
          <p id="progressText" class="text-2xl text-gray-600 dark:text-gray-400 max-w-3xl px-8"></p>
        </div>
      </div>
    `;
