...
performance: {
  factors: [
	...
	{ name: "Render-Blocking Resources & Script Optimization", threshold: 80, shortDesc: "Minimizes render-blocking CSS/JS that delay first paint. Modern best practice allows 1-3 small/optimized blocking items if critical path is short.", howToFix: "Inline or preload critical CSS, defer/async non-critical JS, minify files, remove unused code. Aim for ≤2-3 blocking resources with fast load times."},
  ],
