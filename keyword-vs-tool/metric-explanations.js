const metricExplanations = [
  {
    ...
    how: 'The tool scans the &lt;title&gt; tag and meta description on both pages for the exact or close-match keyword phrase, then compares presence and optimization.',
  ...
  },
  {
    ...
    how: 'The tool checks the first &lt;h1&gt; tag and scans other headings (H2–H6) on both pages for keyword presence, highlighting which page has better structure.',
  ...
  },
  {
    ...
    how: 'Word count is calculated from main content on both pages (excluding navigation, footers, etc.). Keyword mentions are counted, density computed, and results compared side-by-side.',
  ...
  },
  {
    ...
    how: 'All &lt;img&gt; tags on both pages are scanned and alt attributes checked for keyword matches, showing which page uses images more effectively.',
  ...
  },
  {
    ...
    how: 'Internal &lt;a&gt; tags on both pages are analyzed for visible text containing the keyword, revealing differences in internal linking strategy.',
  ...
  },
  {
    ...
    how: 'Both URLs are checked for the keyword. Each page is scanned for &lt;script type="application/ld+json"&gt; tags, comparing relevance and rich snippet eligibility.',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  container.innerHTML = metricExplanations.map(m => `
    <div id="${m.id}" class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-10 hover:shadow-xl transition-shadow border-l-4 border-orange-500 text-center">
      ...
      <details class="group">
        <summary class="cursor-pointer text-orange-500 font-bold hover:underline flex items-center justify-center gap-2 w-full">
