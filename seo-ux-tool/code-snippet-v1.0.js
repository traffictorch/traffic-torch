...
const RULES = [
  ...
  /* ── Controller-aware additions (matched against the actual issue copy
        emitted by the analyze-* modules) ────────────────────────────────── */
  { test: /Heading order|heading structure/i,
    selectors: ['h1, h2, h3, h4, h5, h6'], limit: 12 },
  { test: /main landmark/i, selectors: ['main, [role="main"]'] },
  { test: /lang attribute/i, selectors: ['html'] },
  { test: /web app manifest|manifest\.json/i,
    selectors: ['link[rel="manifest"]', 'head'], limit: 2,
    note: 'No <link rel="manifest"> found — this is your <head> where it belongs.' },
  { test: /Structured data|schema/i,
    selectors: ['script[type="application/ld+json"]'], limit: 6 },
  { test: /Thin content|content depth/i,
    selectors: ['main', 'article', 'p'], limit: 6 },
  { test: /Breadcrumb/i,
    selectors: ['nav[aria-label*="readcrumb" i]', '[class*="breadcrumb" i]'] },
  { test: /calls-to-action/i,
    selectors: ['a[href]:not([href^="#"])', 'button'], limit: 10 },
  { test: /homescreen|apple-touch-icon/i,
    selectors: ['link[rel="apple-touch-icon"]', 'link[rel="icon"]'] },
  { test: /mixed content/i,
    selectors: ['img[src^="http:"]', 'script[src^="http:"]', 'link[href^="http:"]'], limit: 10 },
  { test: /Web fonts|font-display|font optimization/i,
    selectors: ['link[rel="preload"][as="font"]', 'link[href*="font"]'] },
  { test: /Title (?:is )?too (short|long)/i, selectors: ['title'] },
  { test: /Meta description (?:is )?(?:too )?(short|long)/i,
    selectors: ['meta[name="description"]'] },
  { test: /Page weight|HTTP requests|service worker/i,
    selectors: ['head'], limit: 1, maxLen: HEAD_MAX,
    note: 'This failure is a network/runtime metric — showing <head> for context.' }
];
