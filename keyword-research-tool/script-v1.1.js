...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Removed initShareReport and initSubmitFeedback calls
    ...
    async function runAnalysis(params) {
        ...
        try {
            ...
            const overallScore = suggestionsCount > 0 ? Math.min(100, suggestionsCount * 10) : 0; // max 100
            const moduleScores = [
                { name: 'Keyword Suggestions', score: overallScore }
            ];

            // We can also add individual suggestions as passed/failed metrics (pass if they exist)
            ...
            // Build share link with keyword and url params
            ...
            // Find or create the share container
            ...
            if (!shareContainer) {
                ...
                // Insert after the results container, but inside results
                results.appendChild(shareContainer);
            }

            // Call initShareModule
