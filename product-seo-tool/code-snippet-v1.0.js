...
const RULES = [
  // ─────────────────────────────────────────────────────────────────
  // Product SEO Tool — factor names (this tool's actual failure text)
  // ─────────────────────────────────────────────────────────────────
  { test: /Title Tag Optimization/i,
    selectors: ['title'] },
  { test: /Meta Description Relevance/i,
    selectors: ['meta[name="description"]', 'head'], limit: 1, maxLen: HEAD_MAX,
    note: 'No <meta name="description"> found — this is your <head> where it belongs.' },
  { test: /Heading Structure/i,
    selectors: ['h1, h2, h3, h4, h5, h6'], limit: 12 },
  { test: /URL Structure/i,
    selectors: ['link[rel="canonical"]'], limit: 1,
    note: 'URL shape is derived from the canonical/requested URL, not a DOM element.' },
  { test: /Keyword Optimization/i,
    selectors: ['title', 'h1', 'h2', 'p'], limit: 8 },
  { test: /Mobile-Friendliness/i,
    selectors: ['meta[name="viewport"]'] },
  { test: /HTTPS Implementation/i,
    selectors: ['link[rel="canonical"]'], limit: 1,
    note: 'HTTPS status is determined from the URL scheme used at fetch time.' },
  { test: /Canonical Tags/i,
    selectors: ['link[rel="canonical"]'] },
  { test: /Meta Robots Directives/i,
    selectors: ['meta[name="robots"]'] },
  { test: /Sitemap Inclusion Hints/i,
    selectors: ['link[rel="canonical"]'], limit: 1,
    note: 'Sitemap inclusion is inferred from the URL pattern — no single DOM element to show.' },
  ...
  // ─────────────────────────────────────────────────────────────────
  // Original Lighthouse-style rules (kept for legacy / future tools)
  // ─────────────────────────────────────────────────────────────────
