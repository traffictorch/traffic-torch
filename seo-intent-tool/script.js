...
<div class="space-y-8">
  <h3 class="text-4xl font-green-400 text-center mb-8">Prioritised AI-Style Fixes</h3>
	${!hasAuthor ? `
    ...
    <div class="flex gap-6">
      ...
      <div>
        ...
        <div class="mt-4 space-y-3 text-sm">
          <p class="text-blue-500 font-bold">What it is?</p>
          <p class="text-gray-600 dark:text-gray-300">A visible author byline with name, photo, and credentials that proves a real expert created the content.</p>
          <p class="text-green-500 font-bold">How to improve?</p>
          <p class="text-gray-600 dark:text-gray-300">Add a detailed author box with professional headshot, full bio highlighting relevant experience/qualifications, links to social profiles or other work, and clear connection to the topic (e.g., “Written by [Name], 10+ years in [niche]”).</p>
          <p class="text-orange-500 font-bold">Why it matters?</p>
          <p class="text-gray-600 dark:text-gray-300">Search engines heavily weigh proven authorship for E-E-A-T — pages with strong author signals rank higher, build trust faster, and reduce bounce rates significantly.</p>
        </div>
      </div>
    </div>
  </div>` : ''}
  ...
  <div class="p-8 bg-gradient-to-r from-orange-500/10 border-l-8 border-orange-500 rounded-r-2xl">
    <div class="flex gap-6">
      ...
      <div>
        ...
        <div class="mt-4 space-y-3 text-sm">
          <p class="text-blue-500 font-bold">What it is?</p>
          <p class="text-gray-600 dark:text-gray-300">Thorough, comprehensive coverage that fully answers the main query plus all related follow-up questions users typically have.</p>
          <p class="text-green-500 font-bold">How to improve?</p>
          <p class="text-gray-600 dark:text-gray-300">Add in-depth examples, data-backed statistics, step-by-step breakdowns, comparisons, visuals/screenshots, templates or tools, expert quotes, case studies, and expanded FAQs — aim for the most complete resource on the topic.</p>
          <p class="text-orange-500 font-bold">Why it matters?</p>
          <p class="text-gray-600 dark:text-gray-300">Depth remains the strongest on-page ranking factor — search engines consistently reward the most helpful, exhaustive pages with top positions and sustained traffic growth.</p>
        </div>
      </div>
    </div>
  </div>` : ''}
  ...
  <div class="p-8 bg-gradient-to-r from-purple-500/10 border-l-8 border-purple-500 rounded-r-2xl">
    <div class="flex gap-6">
      ...
      <div>
        ...
        <div class="mt-4 space-y-3 text-sm">
          <p class="text-blue-500 font-bold">What it is?</p>
          <p class="text-gray-600 dark:text-gray-300">Structured data (JSON-LD) that explicitly defines your page type and key entities to search engines.</p>
          <p class="text-green-500 font-bold">How to improve?</p>
          <p class="text-gray-600 dark:text-gray-300">Implement at least two relevant types: Article (with author Person link), plus FAQPage, HowTo, Product, or BreadcrumbList as appropriate. Validate with official testing tools before publishing.</p>
          <p class="text-orange-500 font-bold">Why it matters?</p>
          <p class="text-gray-600 dark:text-gray-300">Proper schema unlocks rich results, boosts click-through rates dramatically, strengthens E-E-A-T signals, and helps search engines feature your content more prominently.</p>
        </div>
      </div>
    </div>
  </div>` : ''}
